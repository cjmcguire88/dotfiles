...
c.AliasManager.user_aliases = [
    ("ll", "exa -a --icons --group-directories-first"),
    (
        "lk",
        "exa -lag --group-directories-first --octal-permissions --icons --no-permissions --git",
    ),
    ("nfa", "fastfetch --logo ~/Pictures/icons/blue_theme-icon.png"),
]
...
#  Default: "Python 3.12.6 (main, Sep  7 2024, 21:31:42) [GCC 14.2.1 20240805]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.27.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.12.6 (main, Sep  7 2024, 21:31:42) [GCC 14.2.1 20240805]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.27.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.12.6 (main, Sep  7 2024, 21:31:42) [GCC 14.2.1 20240805]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.27.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.TerminalInteractiveShell.highlighting_style_overrides = {
    Token.PromptPycon: "#a6e3a1",
    Token.Prompt: "#edfefe",  # Green for input prompt text
    Token.PromptArrow: "#27ae60 bold",  # Red for input prompt text
    Token.PromptDirLabel: "#E0C299",  # Green for input prompt text
    Token.PromptCWD: "#1793d1 bold",  # Green for input prompt text
    Token.PromptGit: "#f1502f",  # Green for input prompt text
    Token.PromptNum: "#94e2d5 bold",  # Magenta and bold for the input number
    Token.OutPrompt: "#edfefe bold",  # Red for output prompt text
    Token.OutPromptTime: "#f39c12",  # Red for output prompt text
    Token.OutPromptArrow: "#27ae60 bold",  # Red for output prompt text
}
